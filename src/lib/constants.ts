...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  ...
  hi: {
    'lbl-pid': 'मरीज़ का नाम',
    'lbl-age': 'आयु',
    'lbl-gender': 'लिंग',
    'lbl-edu': 'शिक्षा स्तर',
    'lbl-diag': 'अनंतिम निदान / शिकायत (वैकल्पिक)',
    'lbl-ses': 'सामाजिक-आर्थिक स्तर',
    'lbl-phq': 'PHQ स्कोर',
    'lbl-group': 'समूह (A या B)',
  ...
  ta: {
    'lbl-pid': 'நோயாளியின் பெயர்',
    'lbl-age': 'வயது',
    'lbl-gender': 'பாலினம்',
    'lbl-edu': 'கல்வி நிலை',
    'lbl-diag': 'தற்காலிக நோயறிதல் / புகார் (விருப்பமானது)',
    'lbl-ses': 'சமூக-பொருளாதார நிலை',
    'lbl-phq': 'PHQ மதிப்பெண்',
    'lbl-group': 'குழு (A அல்லது B)',
